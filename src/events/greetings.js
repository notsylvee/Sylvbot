module.exports = {
    ...
    async execute (message) {
        ...
        if (message.content.toLowerCase().startsWith("hello") && message.content.toLowerCase().endsWith("o")) {
            message.channel.send(`${response}`)}
        
        if (message.content.toLowerCase().startsWith("hey") && message.content.toLowerCase().endsWith("y")) {
            message.channel.send(`${response}`)}
        
        if (message.content.toLowerCase().startsWith("howdy") && message.content.toLowerCase().endsWith("y")) {
            message.channel.send(`${response}`)}
        
        if (message.content.toLowerCase().startsWith("hai") && message.content.toLowerCase().endsWith("i")) {
            message.channel.send(`${response}`)}
        
        if (message.content.toLowerCase().startsWith("hewwo") && message.content.toLowerCase().endsWith("o")) {
            message.channel.send(`${response}`)}
        ...
        if (message.content.toLowerCase().startsWith("sup") && message.content.toLowerCase().endsWith("sup")) {
            message.channel.send(`${response}`)}
        
        if (message.content.toLowerCase().startsWith("aloha") && message.content.toLowerCase().endsWith("aloha")) {
            message.channel.send(`${response}`)}
        
        if (message.content.toLowerCase().startsWith("greetings") && message.content.toLowerCase().endsWith("greetings")) {
            message.channel.send(`${response}`)}
    }
}