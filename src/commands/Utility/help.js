...
module.exports = {
    ...
    async execute (interaction, client) {
        ...
        .addFields({ name: "/botinfo", value: "Sends info about this bot" })
        .addFields({ name: "/copy", value: "Copy an emoji to this server" })
        .addFields({ name: "/emoji", value: "Add an emoji to this server" })
        .addFields({ name: "/help", value: "Get a list of all available commands" })
        .addFields({ name: "/ping", value: "Pong! Get the bots ping (ms)" })
        .addFields({ name: "/serverinfo", value: "Sends info about this server" })
        .addFields({ name: "/status", value: "Set bot status (bot owner only)" })
        .addFields({ name: "/sticker", value: "Add a sticker to this server" })
