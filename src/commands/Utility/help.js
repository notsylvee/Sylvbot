...
module.exports = {
    ...
    async execute (interaction, client) {
        ...
        switch (command) {
            ...
            .addFields({ name: "/mod ban", value: "Ban a user from this server" })
            .addFields({ name: "/mod unban", value: "Unban a user from this server" })
            .addFields({ name: "/mod kick", value: "Kick a user from this server" })
            .addFields({ name: "/mod timeout", value: "Timeout a user in this server" })
            .addFields({ name: "/mod untimeout", value: "Remove timeout a user in this server" })
            .addFields({ name: "/mod clear", value: "Clear messages from this channel" })
            .addFields({ name: "/mod slowmode", value: "Enable slowmode in a channel" })
