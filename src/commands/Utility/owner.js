  ...
  data: new SlashCommandBuilder()
      ...
      command
        ...
        .addStringOption((option) =>
          option
            .setName("server")
            .setDescription(
              "ID or name of the server you want the bot to leave",
            )
            .setRequired(true),
        ),
    )
    .addSubcommand((command) =>
      command
        .setName("serverlist")
        .setDescription(
          "Get a list of all the servers this bot is in (bot owner only)",
        ),
    )
    .addSubcommand((command) =>
      command
        ...
        .addStringOption((option) =>
          option
            .setName("server")
            .setDescription("ID of the server you want to get an invite from")
            .setRequired(true),
        ),
    )
    .addSubcommand((command) =>
