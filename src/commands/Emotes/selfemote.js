...
/*switch (command) {
      case "cry":
        ...
        const embed = new EmbedBuilder()
          .setColor("Fuchsia")
          .setAuthor({
            name: `${interaction.member.displayName} cries`,
            iconURL: `${interaction.member.displayAvatarURL({ dynamic: true })}`,
          })
          .setImage(gif);
    ...
    switch (command) {
      case "dance":
        ...
        const embed = new EmbedBuilder()
          .setColor("Fuchsia")
          .setAuthor({
            name: `${interaction.member.displayName} dances!`,
            iconURL: `${interaction.member.displayAvatarURL({ dynamic: true })}`,
          })
          .setImage(gif);
    ...
    switch (command) {
      case "eat":
        ...
        const embed = new EmbedBuilder()
          .setColor("Fuchsia")
          .setAuthor({
            name: `${interaction.member.displayName} eats!`,
            iconURL: `${interaction.member.displayAvatarURL({ dynamic: true })}`,
          })
          .setImage(gif);
    ...
    switch (command) {
      case "giggle":
        ...
        const embed = new EmbedBuilder()
          .setColor("Fuchsia")
          .setAuthor({
            name: `${interaction.member.displayName} giggles!`,
            iconURL: `${interaction.member.displayAvatarURL({ dynamic: true })}`,
          })
          .setImage(gif);
    ...
    switch (command) {
      case "happy":
        ...
        const embed = new EmbedBuilder()
          .setColor("Fuchsia")
          .setAuthor({
            name: `${interaction.member.displayName} is happy!`,
            iconURL: `${interaction.member.displayAvatarURL({ dynamic: true })}`,
          })
          .setImage(gif);
    ...
    switch (command) {
      case "mad":
        ...
        const embed = new EmbedBuilder()
          .setColor("Fuchsia")
          .setAuthor({
            name: `${interaction.member.displayName} is mad!`,
            iconURL: `${interaction.member.displayAvatarURL({ dynamic: true })}`,
          })
          .setImage(gif);
    ...
    switch (command) {
      case "plead":
        ...
        const embed = new EmbedBuilder()
          .setColor("Fuchsia")
          .setAuthor({
            name: `${interaction.member.displayName} pleads!`,
            iconURL: `${interaction.member.displayAvatarURL({ dynamic: true })}`,
          })
          .setImage(gif);
    ...
    switch (command) {
      case "pout":
        ...
        const embed = new EmbedBuilder()
          .setColor("Fuchsia")
          .setAuthor({
            name: `${interaction.member.displayName} pouts! Hmph!`,
            iconURL: `${interaction.member.displayAvatarURL({ dynamic: true })}`,
          })
          .setImage(gif);
    ...
    switch (command) {
      case "sad":
        ...
        const embed = new EmbedBuilder()
          .setColor("Fuchsia")
          .setAuthor({
            name: `${interaction.member.displayName} is sad`,
            iconURL: `${interaction.member.displayAvatarURL({ dynamic: true })}`,
          })
          .setImage(gif);
    ...
    switch (command) {
      case "shy":
        ...
        const embed = new EmbedBuilder()
          .setColor("Fuchsia")
          .setAuthor({
            name: `${interaction.member.displayName} is shy!`,
            iconURL: `${interaction.member.displayAvatarURL({ dynamic: true })}`,
          })
          .setImage(gif);
    ...
    switch (command) {
      case "sleep":
        ...
        const embed = new EmbedBuilder()
          .setColor("Fuchsia")
          .setAuthor({
            name: `${interaction.member.displayName} sleeps! zzZ`,
            iconURL: `${interaction.member.displayAvatarURL({ dynamic: true })}`,
          })
          .setImage(gif);
    ...
    switch (command) {
      case "spin":
        ...
        const embed = new EmbedBuilder()
          .setColor("Fuchsia")
          .setAuthor({
            name: `${interaction.member.displayName} spins!`,
            iconURL: `${interaction.member.displayAvatarURL({ dynamic: true })}`,
          })
          .setImage(gif);
    ...
    switch (command) {
      case "die":
        ...
        const embed = new EmbedBuilder()
          .setColor("Fuchsia")
          .setAuthor({
            name: `${interaction.member.displayName} died 💀`,
            iconURL: `${interaction.member.displayAvatarURL({ dynamic: true })}`,
          })
          .setImage(gif);
    ...
    switch (command) {
      case "tired":
        ...
        const embed = new EmbedBuilder()
          .setColor("Fuchsia")
          .setAuthor({
            name: `${interaction.member.displayName} is tired`,
            iconURL: `${interaction.member.displayAvatarURL({ dynamic: true })}`,
          })
          .setImage(gif);
    ...
    switch (command) {
      case "wave":
        ...
        const embed = new EmbedBuilder()
          .setColor("Fuchsia")
          .setAuthor({
            name: `${interaction.member.displayName} waves!`,
            iconURL: `${interaction.member.displayAvatarURL({ dynamic: true })}`,
          })
          .setImage(gif);
    ...
    switch (command) {
      case "scared":
        ...
        const embed = new EmbedBuilder()
          .setColor("Fuchsia")
          .setAuthor({
            name: `${interaction.member.displayName} is scared`,
            iconURL: `${interaction.member.displayAvatarURL({ dynamic: true })}`,
          })
          .setImage(gif);
    ...
    switch (command) {
      case "sigh":
        ...
        const embed = new EmbedBuilder()
          .setColor("Fuchsia")
          .setAuthor({
            name: `${interaction.member.displayName} sighs`,
            iconURL: `${interaction.member.displayAvatarURL({ dynamic: true })}`,
          })
          .setImage(gif);
    ...
    switch (command) {
      case "blush":
        ...
        const embed = new EmbedBuilder()
          .setColor("Fuchsia")
          .setAuthor({
            name: `${interaction.member.displayName} blushes!`,
            iconURL: `${interaction.member.displayAvatarURL({ dynamic: true })}`,
          })
          .setImage(gif);
    ...
    switch (command) {
      case "drool":
        ...
        const embed = new EmbedBuilder()
          .setColor("Fuchsia")
          .setAuthor({
            name: `${interaction.member.displayName} drools!`,
            iconURL: `${interaction.member.displayAvatarURL({ dynamic: true })}`,
          })
          .setImage(gif);
    ...
    switch (command) {
      case "explode":
        ...
        const embed = new EmbedBuilder()
          .setColor("Fuchsia")
          .setAuthor({
            name: `${interaction.member.displayName} explodes!`,
            iconURL: `${interaction.member.displayAvatarURL({ dynamic: true })}`,
          })
          .setImage(gif);
    ...
    switch (command) {
      case "nod":
        const link = [
          "https://media1.tenor.com/m/Ku0nXSmftncAAAAC/shirosaki-hana-shirosaki.gif",
          "https://media1.tenor.com/m/lNkVGL4mLDAAAAAC/elaina-nod.gif",
          "https://media1.tenor.com/m/7xStm7h_r60AAAAd/anime-anime-girl.gif",
          "https://media1.tenor.com/m/CCikvipAi6kAAAAC/fran-nod.gif",
          "https://media1.tenor.com/m/yzZ2U9gQpZQAAAAC/anime-nod.gif",
          "https://media1.tenor.com/m/uGRG865sv3YAAAAC/yui-nod.gif",
          "https://media1.tenor.com/m/ZUMbZHhkaBoAAAAC/anime-yes.gif",
          "https://media1.tenor.com/m/99_H7NIsa8kAAAAC/we-never.gif",
          "https://media1.tenor.com/m/WcoVJ8aQcwkAAAAC/one-piece-monkey-d-luffy.gif",
        ];
        const gif = link[Math.floor(Math.random() * link.length)];
        ...
        const embed = new EmbedBuilder()
          .setColor("Fuchsia")
          .setAuthor({
            name: `${interaction.member.displayName} nods!`,
            iconURL: `${interaction.member.displayAvatarURL({ dynamic: true })}`,
          })
          .setImage(gif);
    ...
    switch (command) {
      case "shakehead":
        const link = [
          ...
          "https://media1.tenor.com/m/f-udqX_N-28AAAAd/bocchi-the-rock-oomfie-bocchi-the-rock.gif",
          "https://media1.tenor.com/m/1i61l5MoH8sAAAAC/no-nope.gif",
          "https://media1.tenor.com/m/el1y_HRpyGIAAAAC/no-head-shaking.gif",
          "https://media1.tenor.com/m/df7ZeNrYFw0AAAAC/akiha-akiha-tohno.gif",
          "https://media1.tenor.com/m/bgBLV5PY-8IAAAAC/villainess-level-99-akuyaku-reijou.gif",
          "https://media1.tenor.com/m/07VyrQ27IAoAAAAC/no-yui.gif",
          "https://media1.tenor.com/m/Ced4r5ehnPwAAAAC/jahy-jahy-sama.gif",
          "https://media1.tenor.com/m/r030L1UQWlUAAAAC/head-shake-no.gif",
        ];
        const gif = link[Math.floor(Math.random() * link.length)];
        ...
        const embed = new EmbedBuilder()
          .setColor("Fuchsia")
          .setAuthor({
            name: `${interaction.member.displayName} shakes their head!`,
            iconURL: `${interaction.member.displayAvatarURL({ dynamic: true })}`,
          })
          .setImage(gif);
    ...
    switch (command) {
      case "thumbsup":
        const link = [
          ...
          "https://media1.tenor.com/m/yFDrE0-KetUAAAAC/lucky-star-thumbs-up.gif",
          "https://media1.tenor.com/m/g1yD0odUyUEAAAAC/princess-connect-priconne.gif",
          "https://media1.tenor.com/m/gTjXmU6ZHsIAAAAC/thumbs-up-chew.gif",
          "https://media1.tenor.com/m/LbyT0UNhPfEAAAAC/anime-thumbs-up.gif",
          "https://media1.tenor.com/m/TXvwW9ePAt0AAAAC/dragon-maid-thumbs-up.gif",
          "https://media1.tenor.com/m/r6VZ-oJoyqUAAAAC/anime-thumbs-up.gif",
          "https://media1.tenor.com/m/W_WjhH0GXnoAAAAC/kou-toilet-bound-hanako-kun.gif",
        ...
        const embed = new EmbedBuilder()
          .setColor("Fuchsia")
          .setAuthor({
            name: `${interaction.member.displayName} gives a thumbs up!`,
            iconURL: `${interaction.member.displayAvatarURL({ dynamic: true })}`,
          })
          .setImage(gif);
    ...
    switch (command) {
      case "peace":
        ...
        const embed = new EmbedBuilder()
          .setColor("Fuchsia")
          .setAuthor({
            name: `${interaction.member.displayName} hold up a peace sign!`,
            iconURL: `${interaction.member.displayAvatarURL({ dynamic: true })}`,
          })
          .setImage(gif);
