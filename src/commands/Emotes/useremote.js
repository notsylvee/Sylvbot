...
module.exports = {
    ...
    .addSubcommand(command =>
        ...
        .addUserOption(option => option.setName('user').setDescription('Whos hand you want to hold').setRequired(true)))
    .addSubcommand(command =>
        command
        .setName('hug')
    ...
    .addSubcommand(command =>
        ...
        .addUserOption(option => option.setName('user').setDescription('Who you want to kill').setRequired(true)))
    .addSubcommand(command =>
        command
        .setName('kiss')
